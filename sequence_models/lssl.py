...
from sequence_models.functional import krylov, causal_convolution
from sequence_models.hippo import transition, hippo
from sequence_models.base import SequenceModule, TransposedModule
from sequence_models.components import Activation
    ...
    def __init__(
        ...
        if self.learn == 0:
            if measure == 'identity': # for testing
                ...
                raise NotImplementedError('Removed it, maybe should bring it back')
